...
<div class="con_mob_pad">
	...
	<ul class="bul_type1 mg_b40">
		<li>초등부 : 부산시내 초등학교 1~3학년 / 초등학교 4~6학년</li>
		<li>중.고등부 : 부산시내 중학교 1~3학년 / 고등학교 1~3학년</li>
		<li>일반부 : 부산시내 거주 일반 성인 누구나(대학생 포함)</li>
	</ul>
	
	<h2 class="tbul1">독후감제출기준</h2>
	<ul class="bul_type1 mg_b40">
		<li>초등부 : 200자 원고지 기준 5매(A4 1매, 글자크기 12포인트,줄간격 160%)이상</li>
	...
	<ul class="bul_type1 mg_b10">
		<li>각계 각층의 추천 권장 도서</li>
		<li>공공도서관 추천 <이달의 책> 선정도서 , 감명 깊게 읽은 책 등 (※ 별도의 지정도서 없음)</li>
	</ul>		
	<div class="mg_b40 btn_blue"><a href="#" target="_blank">추천도서 바로가기</a></div>
		...
		<table class="tb_board">
			...
			<c:forEach var="brd"  items="${ boardList }">	
				<tr>
					...
					<td>${brd.bd_idx}</td>
					<td class="l"><a href="/bkreport01_read?bd_catcode=CAT0005&m1=05&m2=08&m3=01&page=${pageMaker.endPage}&perPageNum=10&searchType=${search}&keyword=${key}&bd_idx=${brd.bd_idx}&flag=1">${brd.bd_title}</a></td>
					<td>${brd.bd_writer}</td>
